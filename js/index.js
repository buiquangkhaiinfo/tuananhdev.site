...
// ABOUT ME
document.getElementById("VietKhanhAbout_1").innerHTML = 'TuanAnhDev.site is a free source code sharing blog with quality and diverse content, we want to become a trusted destination for the programming community.';
// FOOTER
...
// USER NAME + TÍCH XANH
document.getElementById("userName").innerHTML = 'Thái Đinh Tuấn Anh <img src="https://i.imgur.com/rvH273O.gif" width="40" height="40" alt="Tích Xanh">';
// CHECK FPS
...
let typed = new Typed(".GioiThieu", {
  strings: ["Hi my name is TuanAnh","Hello, I'm a Tricker.", "I like marketing facebook or rename 🚀"],
  typeSpeed: 95,
  backSpeed: 75,
  loop: true
})
...
function Youtube() {
  setTimeout(function() {
    window.open('https://www.youtube.com/channel/UChJnpbNot310anDChpzas6Q', '_blank')},
  100);
}
function Facebook() {
  setTimeout(function() {
...
function Discord() {
  setTimeout(function() {
    window.open('https://dsc.bio/tuananhuser', '_blank')},
  100);
}
function Instagram() {
  setTimeout(function() {
    window.open('https://www.instagram.com/thaidinhtuananh5/', '_blank')},
  100);
}
...
toastDiv.id = 'Toast';
toastDiv.textContent = '𝘿𝙚𝙨𝙞𝙜𝙣 𝙗𝙮 𝑻𝙪𝒂𝙣𝑨𝙣𝒉 🚀';
